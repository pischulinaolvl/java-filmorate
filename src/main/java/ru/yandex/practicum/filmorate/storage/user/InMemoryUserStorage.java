...
public class InMemoryUserStorage implements UserStorage {
    ...
    @Override
    public void removeUser(Long id, Logger log) {
        users.remove(id);
    }
    ...
    public User updateUser(User newUser, Logger log) {
        ...
        if (users.containsKey(newUser.getId())) {
            ...
            log.trace("User Update Поиск пользователя по полю id");
        ...
        log.warn("WARN User Update Пользователь с id = {} не найден", newUser.getId());
